 ...
 * 注意：xml中需要给session配置未无状态type="stateless"
 */
public class HelloWorldExample2 {
    ...
    public static void execute(KieServices ks, KieContainer kc) {
        ...
        StatelessKieSession ksession = kc.newStatelessKieSession("HelloWorldKS_2");
        ...
        final com.lk.drools.HelloWorldExample.Message message = new HelloWorldExample.Message();
